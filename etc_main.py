...
parser.add_argument("-k", "--k_num", help="Model will select the best suitable ETC word from k candidates. In paper, "
                                          "we use 1. And we encourage you to try different numbers to achieve better "
                                          "result.", type=int, required=False, default=1)
